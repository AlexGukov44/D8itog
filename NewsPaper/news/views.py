...
class PostCreateView(LoginRequiredMixin, CreateView, PermissionRequiredMixin):   # создание поста
    permission_required = 'news.add_post'
    template_name = 'post_add.html'
    form_class = PostForm


class PostUpdateView(LoginRequiredMixin, UpdateView, PermissionRequiredMixin):   # редактирование поста
...
class PostDeleteView(LoginRequiredMixin, DeleteView, PermissionRequiredMixin):
